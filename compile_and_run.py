...
for root, _, _ in os.walk(f"{MAIN_TESTS_FOLDER}"):
    ...
    for test_in in tests_in:
        ...
        compile_process = subprocess.Popen("./hw5", stdin=fanC_file, stdout=llvm_file)
        ...
        llvm_process = subprocess.Popen("lli", stdin=llvm_file, stdout=fanC_out_file)
        llvm_process.communicate()
        ...
        stdout, _ = diff_process.communicate()
